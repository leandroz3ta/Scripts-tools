...
if [ "$OPCAO" -eq 1 ]; then  #analisa a escolha digitada pelo usuário
	...
	apt-get update; echo "Passo 7 - Instalando Java..."; 
	apt-get -y install oracle-java8-installer oracle-java8-set-default; 
	echo "Passo 8 - Atualizando lista de repositorios..."; 
	apt-get update; echo "Passo 9 - Instalando MySql server..."; 
	apt-get install -y mysql-server; 
	echo "Passo 10 - Inicializando servicos do Mysql server..."; 
	service mysql start; 
	echo "Passo 11 - Instalando servidor Apache..."; 
	apt-get install -y apache2 php5 php5-mysql libapache2-mod-php5 php5-gd php-net-socket libpq5 libpq-dev mysql-server mysql-client libmysqld-dev phpmyadmin; 
